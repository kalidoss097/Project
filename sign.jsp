...
<body style="background-color:orange";>
 ...
 <h1 style="font-size:800%">Register</h1>
	<form tag="Create Logon">
		<div align="center">
			 <div class = "col-sm-5"> <input type="text" class="form-control" name="username" placeholder="Username" required autofocus>
                <input type="password" class="form-control" name="psswrd" placeholder="Password" required>
                <input type="password" class="form-control" name="cpsswrd" placeholder="Confirm Password" required>
...
<marquee style="font-size:300%;">Note: Please make sure that all fields marked with * are completed!.</marquee>
